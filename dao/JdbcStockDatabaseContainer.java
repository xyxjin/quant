...
//import dao.IMutableOHLCTimeSeries;
//import dao.IMutableTickTimeSeries;
import dao.IOHLCPoint;
import dao.IStockDatabase;
import dao.IStockDatabaseContainer;
import dao.ITickPoint;
...
public class JdbcStockDatabaseContainer implements IStockDatabaseContainer {
	...
	public void init() throws SQLException {
		stockDbHeaderDao.initDb(null);
		ohlcPointDao.initDb(null);
		tickPointDao.initDb(null);
	}
