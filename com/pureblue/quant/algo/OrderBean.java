...
public class OrderBean implements IOrder, Serializable {
	...
	public static OrderBean copyOf(IOrder source) {
		...
		if(source.getContract() != null){
			copy = new OrderBean(source.getContract(), source.getSide(), source.getType(), source.getAmount(), source.getLimitPrice(), source.getAuxPrice());
		}
		return copy;
		/*
		...
		System.out.println("order bean contract: "+copy.getContract());
