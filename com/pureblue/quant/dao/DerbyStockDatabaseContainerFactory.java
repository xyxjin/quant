...
import com.pureblue.quant.dao.IStockDatabaseContainer;
import com.pureblue.quant.dao.IStockDatabaseContainerFactory;
import com.pureblue.quant.dao.JdbcStockDatabaseContainer;
...
public class DerbyStockDatabaseContainerFactory implements IStockDatabaseContainerFactory {
	...
	*/
	...
	public IStockDatabaseContainer getInstance(String id) throws SQLException {
		...
		JdbcStockDatabaseContainer stockDbContainer = new JdbcStockDatabaseContainer(stockDbHeaderDao, ohlcPointDao, null);
