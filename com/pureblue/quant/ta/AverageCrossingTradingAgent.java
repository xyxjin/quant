...
import com.pureblue.quant.algo.IOrderReceiver;
...
import com.pureblue.quant.calendar.CalendarTradingSchedule;
import com.pureblue.quant.calendar.ITradingCalendar;
...
import com.pureblue.quant.dao.TimeSeriesTail;
...
public class AverageCrossingTradingAgent implements ITradingAgent, ISeriesListener<Date, Double> {
	...
	public void wire(Map<String, ? extends ISeries<Date, Double, ? extends ISeriesPoint<Date, Double>>> inputSeries, ISeriesAugmentable<Date, Double, ISeriesPoint<Date, Double>> outputSeries) {
		...
		System.out.println(stockTimeSeries.getLast().getClose().toString());
	}
	...
	private void updatePosition() {
		//System.out.println("enter updatePosition");
		...
		//System.out.println(stockTimeSeries.size());
		...
		if (deltaPosition != 0) {
			try {
					...
					//System.out.println(order.getContract().getSymbol());
		...
		//System.out.println("end updateposition");
	}
