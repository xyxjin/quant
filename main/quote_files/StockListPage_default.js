...
// 首页概念板块数据
ConceptionBlockDefault = new function()
{
	// 显示条数
	this.count = 16;
	...
	this.ShowData = function (data)
	{
		...
		{		
			hc.push('<li>');
			hc.push(' <a href="/stock/conseption.aspx?code=' + data[index].type_code + '&name=' + data[index].type_name + '" class="black" title="' + data[index].type_name + '">' + data[index].type_name + '</a>');
			hc.push('</li>');
