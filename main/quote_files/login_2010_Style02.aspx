...
{
hexunMember_loginSetup_referrer="http://quote.hexun.com/";
}
...
hexunMember_loginSetup_Put_HTML+="</div>"
        ...
        {
            popup('µÇÂ¼','http://reg.hexun.com/OtherInterFace/IFR_userLoginDialog_01.aspx?gourl=http%3a%2f%2fquote.hexun.com%2f','180');;
            return;
        }
        else
        {
